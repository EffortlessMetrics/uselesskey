...
//! | `ssh` | OpenSSH key/certificate fixtures |
...
pub use uselesskey_ssh::{
    DOMAIN_SSH_CERT, DOMAIN_SSH_KEY, SshCertFixture, SshCertSpec, SshCertType, SshCertValidity,
    SshFactoryExt, SshKeyFixture, SshSpec,
};
...
pub mod prelude {
    ...
    #[cfg(feature = "ssh")]
    pub use crate::{
        SshCertFixture, SshCertSpec, SshCertType, SshCertValidity, SshFactoryExt, SshKeyFixture,
        SshSpec,
    };
