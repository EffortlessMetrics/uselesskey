...
pub(super) fn render_profiles(explain: bool) -> String {
...
pub(super) fn render_profile_summary(profile: BundleProfile) -> String {
    let info = profile_info(profile);
    format!(
        concat!(
            "Profile: {}\n",
...
pub(super) fn render_profile_explanation(profile: BundleProfile) -> String {
    let info = profile_info(profile);
